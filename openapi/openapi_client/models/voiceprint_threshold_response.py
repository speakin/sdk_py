...
class VoiceprintThresholdResponse(object):
    ...
    def __init__(self, threshold=None):  # noqa: E501
        """VoiceprintThresholdResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VoiceprintThresholdResponse):
            return False
